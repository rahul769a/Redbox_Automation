...
public class FabTrayKeyboadValidation {
...
HomePage homePage;
String moduleName = "New Release screen";
...
try {
Assert.assertTrue(searchPage.isKeyboardDisplayed());
reports.writeIntoFile(driver, testCaseName,  "Tap on Search Icon", "Verify of Keyboard present", "Keyboard  is DIsplayed", reports.pass, "", comlib.getCurrentTime());
}
catch(Exception e)
{
reports.writeIntoFile(driver, testCaseName,  "Tap on Manage Search Icon", "Keyboard is Not Displayed", "Keyborad is Not Displayed", reports.fail, e.getMessage(), comlib.getCurrentTime());
